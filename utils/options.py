...
def args_parser():
    ...
    parser.add_argument("--dataset", type=str, default=Input_DS, choices=["EMNIST","human_activity", "gleam","vehicle_sensor","mnist", "Synthetic", "Cifar10","fmnist","Cifar100"])
    # parser.add_argument("--server_model", type=str, default="cnn", choices=["cnn","resnet"])
    parser.add_argument("--client_model", type=str, default="cnn", choices=["cnn", "resnet"])
    ...
    parser.add_argument("--beta", type=float, default=0, help="Average moving parameter for pFedMe, or Second learning rate of Per-FedAvg")
    ...
    parser.add_argument("--K_Layer_idx", nargs="*", type=int, default=0, help="Model Layer Index")
