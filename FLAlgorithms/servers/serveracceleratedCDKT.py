...
class CDKT(Dem_Server):
    ...
    def generalized_knowledge_construction(self, epochs,dataset):
        LOSS = 0
        ...
        for glob_iter in range(self.num_glob_iters):
            ...
            for user in self.selected_users:
                if(glob_iter==0):
                    ...
                    user.train_distill(self.local_epochs,self.model)
            ...
            if Ensemble == True:
                ...
                self.generalized_knowledge_construction(global_generalized_epochs,self.args.dataset)
