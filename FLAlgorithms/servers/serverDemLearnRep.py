...
from FLAlgorithms.users.userDemLearnRep import UserDemLearn
        ...
        for i in range(self.num_glob_iters):
            ...
            for user in self.users:
                ...
                if (i == 0):
                    ...
                    g_weights = self.get_hierrachical_representation(user)  #parameters of generalized representations
